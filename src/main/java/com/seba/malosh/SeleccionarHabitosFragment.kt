    ...
    override fun onCreateView(
        ...
        siguienteButton.setOnClickListener {
            ...
            if (selectedHabits.size < 2) {
                ...
                // Acciones cuando la selección es válida
                Toast.makeText(context, "Selección válida", Toast.LENGTH_SHORT).show()
                // Aquí puedes pasar a la siguiente pantalla o acción
            }
        }
